                ...
                <div className="flex justify-end mt-4">
                  {canEnableNext && (
                    <button
                      ...
                      className="group relative px-6 py-3 font-bold text-white rounded-lg overflow-hidden bg-gradient-to-br from-[#0b77b7] to-[#06486e] hover:from-[#0b77b7] hover:to-[#06486e] transition-all duration-300 ease-out shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:ring-opacity-75"
                    >
