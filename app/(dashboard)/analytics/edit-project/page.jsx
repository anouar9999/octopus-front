...
const [range, setrange] = useState(0);
  return (<div className="m-5">
    ...
    <div className="grid lg:grid-cols-3 grid-cols-1 gap-5 ">
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-5"></div>
    </div>
  ...
  <input className="range" type="range" defaultValue={0} min={0} max={100} onChange={(e)=>{setrange(e.target.value)}} onMouseMove={(e)=>{
