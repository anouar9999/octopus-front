...
import UpdateRegion from "@/components/partials/app/portals/updatePortals/UpdateRegion";
    ...
    const fetchPortals = async () => {
      try {
        const response = await axios.get(
          `${process.env.NEXT_PUBLIC_API_URL}/api/cities/${params.cities}/regions/`
        );
      ...
      <div class="flex  items-center justify-center ">
        <div>
          ...
          >
            ...
            userData?.user.is_admin === "undefind" ? (
            ...
            {Subportals.map((portal) => (
              <>
                <GridPortals
                  ...
                  handleUpdate={() =>
                    dispatch(
                      editPortalModel({ open: true, categoryId: portal.id })
                    )
                  }
                />
             ...
             <AddRegion
                  CityID={params.cities}
                />
                                {/* <UpdateRegion RegionID={portal.id} /> */}
