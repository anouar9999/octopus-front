    ...
    <div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 ">
          ...
          <div className={errors.assign ? "has-error" : ""}>
            <label className="form-label font-sans" htmlFor="icon_s">
              Assignee
            </label>
            <Controller
              name="assign"
              ...
              render={({ field }) => (
                <Select
                  ...
                  styles={styles}
                  className="react-select font-sans"
          ...
          <Textarea label="Description " placeholder="Description" className="font-sans" />

          <div className="ltr:text-right rtl:text-left">
            <button className="btn btn-dark font-sans text-center">Add</button>
          </div>
        </form>
