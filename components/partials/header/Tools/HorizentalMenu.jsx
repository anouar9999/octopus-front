...
import { isAdmin, topMenu } from "@/constant/data";
        ...
        {topMenu?.map((item, i) => (
          ...
          >
            ...
            {!item.child && !item.megamenu && (
              <Link  href={ isAdmin? `${item.link}` :"/analytics"}>
                <div className={isAdmin ?"flex flex-1 items-center space-x-[6px] rtl:space-x-reverse":"flex flex-1 items-center space-x-[6px] rtl:space-x-reverse hidden "}>
